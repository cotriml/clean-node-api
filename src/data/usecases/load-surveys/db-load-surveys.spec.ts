...
const makeLoadSurveysRespository = (): LoadSurveysRepository => {
...
const makeSut = (): SutTypes => {
  const loadSurveysRepositoryStub = makeLoadSurveysRespository()
...
describe('DbLoadSurveys', () => {
  ...
  test('Should return a list of Sruveys on success', async () => {
    const { sut } = makeSut()
