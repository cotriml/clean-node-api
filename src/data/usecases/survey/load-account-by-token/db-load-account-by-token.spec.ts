...
describe('DbLoadAccountByToken Usecase', () => {
  ...
  test('Should call LoadAccountByTokenByRepository with correct values', async () => {
  ...
  test('Should return null if LoadAccountByTokenByRepository returns null', async () => {
    const { sut, loadAccountByTokenRepositoryStub } = makeSut()
  ...
  test('Should throw if LoadAccountByTokenByRepository throws', async () => {
    const { sut, loadAccountByTokenRepositoryStub } = makeSut()
